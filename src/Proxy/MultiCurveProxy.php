 ...
 */
final readonly class MultiCurveProxy extends MultiCurve implements ProxyInterface
{
    /**
     * The WKT or WKB data.
     */
     ...
     */
    private function load() : MultiCurve
    {
    ...
    #[Override]
    public function project(\Brick\Geo\Projector\Projector $projector): \Brick\Geo\MultiCurve
    {
