...
class TriangleProxy extends \Brick\Geo\Triangle
{
    ...
    public function exteriorRing()
    {
        ...
        return $this->geometry->exteriorRing();
    }
    ...
    public function numInteriorRings()
    {
        ...
        return $this->geometry->numInteriorRings();
    }
    ...
    public function interiorRingN($n)
    {
        ...
        return $this->geometry->interiorRingN($n);
    }
     ...
     * {@inheritdoc}
     */
    public function equals(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function disjoint(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function intersects(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function touches(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function crosses(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function within(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function contains(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function overlaps(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function relate(\Brick\Geo\Triangle $geometry, $matrix)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function distance(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function intersection(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function union(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function difference(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function symDifference(\Brick\Geo\Triangle $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
