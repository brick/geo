 ...
 *           Please type-hint against Brick\Geo\Triangle in your projects.
 */
final readonly class TriangleProxy extends Triangle implements ProxyInterface
{
    /**
     * The WKT or WKB data.
     */
     ...
     */
    private function load() : Triangle
    {
    ...
    #[Override]
    public function project(\Brick\Geo\Projector\Projector $projector): \Brick\Geo\Triangle
    {
