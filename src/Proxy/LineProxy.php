...
class LineProxy extends \Brick\Geo\Line
{
     ...
     * {@inheritdoc}
     */
    public function equals(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function disjoint(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function intersects(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function touches(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function crosses(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function within(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function contains(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function overlaps(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function relate(\Brick\Geo\Line $geometry, $matrix)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function distance(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function intersection(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function union(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function difference(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
     ...
     * {@inheritdoc}
     */
    public function symDifference(\Brick\Geo\Line $geometry)
    {
        if ($this->geometry === null) {
            $this->load();
        }
