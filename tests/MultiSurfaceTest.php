...
class MultiSurfaceTest extends AbstractTestCase
{
    ...
    {
        return [
            ['MULTIPOLYGON (((1 1, 1 3, 4 3, 4 6, 6 6, 6 1, 1 1)))', 'POINT (4.0625 2.9375)'],
            ['MULTIPOLYGON (((0 0, 0 4, 3 4, 3 3, 4 3, 4 0, 0 0)))', 'POINT (1.9 1.9)'],
    ...
    public function providerPointOnSurface()
    {
        return [
            ...
            ['MULTIPOLYGON Z (((1 1 0, 1 3 0, 4 3 0, 4 5 0, 6 5 0, 6 1 0, 1 1 0)), ((2 4 0, 2 6 0, 4 6 0, 2 4 0)))'],
        ];
    }
}
